                ...
                <div class="card-body">
                    ...
                    <form action="<?= route_to('register') ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control <?php if(session('errors.lastname')) : ?>is-invalid<?php endif ?>" name="lastname" placeholder="<?=lang('Auth.lastname')?>" value="<?= old('lastname') ?>">
                        </div>
