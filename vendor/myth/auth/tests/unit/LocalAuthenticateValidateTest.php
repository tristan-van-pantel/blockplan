...
class LocalAuthenticateValidateTest extends CIUnitTestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->auth = Services::authentication('local', $this->, $this->loginModel,false);
    ...
    {
        $this->->shouldReceive('where')->once()->with(\Mockery::subset(['email' => 'joe@example.com']))->andReturn($this->);
        $this->->shouldReceive('first')->once()->andReturn(null);
    ...
    public function testFailsPasswordValidation()
    {
        ...
        $this->->shouldReceive('where')->once()->with(\Mockery::subset(['email' => 'joe@example.com']))->andReturn($this->);
        $this->->shouldReceive('first')->once()->andReturn($user);
