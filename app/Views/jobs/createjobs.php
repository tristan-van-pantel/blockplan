...
<div class="card mb-3">
    <h3 class="card-header text-white bg-dark">Create Praktika-/ Arbeitsangebote
    </h3>
    ...
    <div class="card-body">
        ...
        <div class="m-5">
            ...
            <form action="<?=route_to('insertjobs')?>" method="post">
                <?=csrf_field()?>
                ...
                <input id="z" type="hidden" name="jobs">
...
<div class="card mb-5">
    <h3 class="card-header text-white bg-dark"> Manage Jobs</h3>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="<?= route_to('deletejobs') ?>" method="post" class="float-left">
                            <?= csrf_field() ?>
                            <input type="hidden" name="jobs_id" value="<?= $item->id ?>" />
